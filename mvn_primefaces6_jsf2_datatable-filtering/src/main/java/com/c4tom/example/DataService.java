...
public enum DataService {
    ...
    DataService() {
        ...
        for (int i = 1; i < 100; i++) {
            ...
            employee.setPhoneNumber(String.format("%s-%s-%s", dataFactory.getNumberText(2),dataFactory.getNumberText(4), dataFactory.getNumberText(4)));
            employee.setAddress(dataFactory.getAddress() + "," + dataFactory.getCity());
            employee.setDepartment(dataFactory.getItem(departments));
            employee.setBirthdate(dataFactory.getBirthDate());
